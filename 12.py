...
cl = LINETCR.LINE()
cl.login(token='EqAjkBZ9OWWLDSzIPSOe.ccys8tuFvu++SAeG8YQBdG.svBD/OZ5GQ4r1e7p3JCkpnWIQLOjIWmYvyF9huDtdz')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='ErSvD3iA0ug2AWpdNySf.AHkgiR7ohkhvn/uWSJHPtW.GK9Rj0qAquNmyhPX3wlBqupRhv0tQRXPJeRon+gSu84')
ki.loginResult()
...
owner =["u082612f1351f554fffb1a120f32a9b0e"]
...
≫ Aku Ga Jawab PM Karna Aku Cuma Bot :( ≪
≫ Queso ≪
            ...
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  cl.sendText(op.param1, "Mau Invite Siapa kak ??? \nJangan Sok Jadi Jagoan deh .\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                except:
          ...
          if wait["Protectcancel"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                random.choice(KAC).sendText(op.param1, "Jangan Sok Jadi Jagoan Deh Lu.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])   
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Goodbye Maaf cupu :( ")
    ...
    for zx in range(0,200):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by Queso\n\n™By Self bot")
